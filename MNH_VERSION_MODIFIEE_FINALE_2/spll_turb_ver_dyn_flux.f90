...
!
REAL, DIMENSION(:,:),   INTENT(IN)   ::  PSEA_UCU      ! ocean current along X
REAL, DIMENSION(:,:),   INTENT(IN)   ::  PSEA_VCU      ! ocean current along Y
!
...
!
CALL TRIDIAG_WIND(KKA,KKU,KKL,PUM,PSEA_UCU,ZA,ZCOEFS(:,:,1),PTSTEP,PEXPL,PIMPL,   &
...
CALL TRIDIAG_WIND(KKA,KKU,KKL,PVM,PSEA_VCU,ZA,ZCOEFS(:,:,1),PTSTEP,PEXPL,PIMPL,  &
