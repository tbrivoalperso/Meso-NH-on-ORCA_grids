...
IF (LCARTESIAN) THEN
  ...
  XMAP=1.
ELSE
  CALL SM_GRIDPROJ(CLUOUT,XXHAT,XYHAT,XZHAT,XXHAT2D,XYHAT2D,XZS,LSLEVE,XLEN1,XLEN2,XZSMT,XLATORI,XLONORI, &
                   XLAT,XLON,xlonu,xlatv,xlatt,XMAP,XDXHAT,XDYHAT,XDXHAT2D,XDYHAT2D,XZZ,XJ)
