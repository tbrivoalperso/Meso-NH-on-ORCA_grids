!depfile:tridiag_wind.D
!     ######spl
      MODULE MODI_TRIDIAG_WIND
!     ########################
INTERFACE
!
       SUBROUTINE TRIDIAG_WIND(KKA,KKU,KKL,PVARM,PSEA_CU,PA,PCOEFS,PTSTEP,PEXPL,PIMPL, &
...
REAL, DIMENSION(:,:),      INTENT(IN)  :: PSEA_CU    ! sfc oceanic current//PVARM
