...
ELSE
  CALL SM_GRIDPROJ(CLUOUT,XXHAT,XYHAT,XZHAT,XXHAT2D,XYHAT2D,ZZS_LS,LSLEVE,XLEN1,XLEN2,ZZSMT_LS,&
                   XLATORI,XLONORI,XLAT,XLON,xlonu,xlatv,xlatt,XMAP,XDXHAT,XDYHAT,XDXHAT2D,XDYHAT2D,ZZZ_LS,ZJ)
  CALL SM_GRIDPROJ(CLUOUT,XXHAT,XYHAT,XZHAT,XXHAT2D,XYHAT2D,XZS   ,LSLEVE,XLEN1,XLEN2,XZSMT   ,&
                   XLATORI,XLONORI,XLAT,XLON,xlonu,xlatv,xlatt,XMAP,XDXHAT,XDYHAT,XDXHAT2D,XDYHAT2D,XZZ   ,ZJ)
END IF
!
