...
!
USE MODE_FMREAD     ! EDIT T Brivoal
!
...
CALL FMREAD(CINIFILEPGD,'XHAT2D',CLUOUT0,'XY',XXHAT2D,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'YHAT2D',CLUOUT0,'XY',XYHAT2D,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'LAT',CLUOUT0,'XY',XLAT,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'LON',CLUOUT0,'XY',XLON,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'latu',CLUOUT,'XY',xlatu,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'lonu',CLUOUT,'XY',xlonu,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'latv',CLUOUT,'XY',xlatv,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'lonv',CLUOUT,'XY',xlonv,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'latt',CLUOUT,'XY',xlatt,IGRID,ILENCH,YCOMMENT,IRESP)
CALL FMREAD(CINIFILEPGD,'lont',CLUOUT,'XY',xlont,IGRID,ILENCH,YCOMMENT,IRESP)
